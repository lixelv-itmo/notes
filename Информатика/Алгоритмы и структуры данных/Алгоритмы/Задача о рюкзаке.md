...
**Цель:** выбрать набор предметов с максимальной суммарной ценностью, не превышая вместимость рюкзака. То есть максимизировать $\sum_{i=1}^{n} v_i \cdot x_i$ при ограничении $\sum_{i=1}^{n} w_i \cdot x_i \le W$, где $x_i \in \{0, 1\}$.
